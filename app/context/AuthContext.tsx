...
// // CRITICAL FIX: Explicitly exported AuthContext so external hooks can see it
...
//       setUser({
//         user_id: storedUser.user_id, // Respects schema mapping
...
//       if (response.success) {
//         const userData = {
//           user_id: response.user_id, // Map database response to hook state
