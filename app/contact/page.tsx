  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <HeroSection
        ...
        subtitle="Ready to turn ideas into production-ready software systems? Let’s discuss how we can build something together."
      />
              ...
              >
                <div>
                  ...
                  <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-6 sm:mb-8">
                    I’m open to discussing software engineering opportunities, including backend systems, full-stack applications, AI systems, and distributed architecture projects. Whether you have a specific idea or are exploring collaboration, feel free to reach out.
                  </p>
                </div>
