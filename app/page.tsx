...
export default function HomePage() {
  ...
  //                 >
  //                   Hi, I'm <span className="text-emerald-600">Alexander Cyril</span>
  //                 </motion.h1> */}
  ...
  //                   className="text-xl md:text-3xl font-semibold text-slate-700 mb-6"
  //                 >
  ...
  //           size="icon"
  //           onClick={prevSlide}
  //           className="bg-white/90 backdrop-blur-sm hover:bg-white border-emerald-200"
  //         >
  ...
  //                 index === currentSlide ? "bg-emerald-600 w-8" : "bg-white/60 w-3"
  //               }`}
  //             />
  //           ))}
  //         </div>
