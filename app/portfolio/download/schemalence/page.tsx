...
//   installUrl: "/downloads/SchemaLence_Setup.exe",
...
import { useState } from "react"
import { motion } from "framer-motion"
import { Download, ArrowRight, Info, Settings, Check, Smartphone, Database, Search, FileText } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import Navigation from "@/components/navigation"
...
const features = [
  {
    ...
    description: "Connect via connection string or form fields (host, port, database, user, password) instantly.",
    icon: Database,
  },
  {
    title: "Schema Browser",
    description: "Browse all tables in the public schema with an intuitive sidebar navigation pane.",
    icon: ArrowRight,
  },
  {
    title: "Comprehensive Schema Analysis",
    description: "View descriptions, columns, foreign/primary keys, unique constraints, indexes, triggers, and ENUM values.",
    icon: Search,
  },
  {
    title: "Data Grid & Export",
    description: "View table data up to 500 rows in a sortable treeview, export to CSV, or copy schema details to clipboard.",
    icon: FileText,
  },
]
...
const appSlides = [
  {
    id: 1,
    title: "SchemaLence Dashboard",
    description: "Quickly link your PostgreSQL instance using connection strings or detailed form fields.",
    image: "/images/portfolio/schemaLence-1.png",
  },
//   {
//     id: 2,
//     title: "Database Connection Manager",
//     description: "The modern and intuitive interface featuring a ttkbootstrap cyborg dark theme configuration.",
//     image: "/images/portfolio/schemaLence-2.png",
//   },
  {
    id: 3,
    title: "Comprehensive Schema Analyzer",
    description: "Deep dive into your table architecture, foreign keys, triggers, constraints, and indexes.",
    image: "/images/portfolio/schemaLence-3.png",
  },
  {
    id: 4,
    title: "Interactive Data Treeview",
    description: "Explore up to 500 records of table values directly with robust sortable grid views.",
    image: "/images/portfolio/schemaLence-4.png",
  },
  {
    id: 5,
    title: "Documentation & Export Utilities",
    description: "Easily copy clean schema definitions to clipboard or export dataset selections into CSV formats.",
    image: "/images/portfolio/schemaLence-5.png",
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-slate-900 mb-4">
                Download <span className="text-emerald-600">SchemaLence</span>
              </h1>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                A PostgreSQL database schema viewer and data exploration tool with a desktop GUI, packaged as a standalone executable using PyInstaller.
              </p>
            </motion.div>
                ...
                <Card className="border-2 border-emerald-200 bg-emerald-50">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-slate-600">Platform:</span>
                        <span className="font-medium mb-4 block">Windows 8, 10, 11 (32-bit & 64-bit)</span>
                      </div>
                    </div>
                    ...
                    <Button
                      ...
                      disabled={isDownloading}
                      className="bg-emerald-600 hover:bg-emerald-700 text-white w-full mt-4 py-6 text-lg font-semibold shadow-md transition-all"
                    >
                      {isDownloading ? "Downloading..." : "🚀 Download Standalone (.exe)"}
                    </Button>
                    <p className="text-xs text-center text-slate-500 mt-3">
                      Zero configuration, no setup required. Runs completely standalone out of your local drive.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      <FullWidthSection className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Key Features</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Comprehensive Schema Analysis and PostgreSQL data exploration architecture inside a lightweight standalone workflow
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Quick Start Guide</h2>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Get started with SchemaLence on your system in three effortless actions
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">System Requirements</h2>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Ensure your platform configuration matches these criteria for smooth operations
              </p>
            </motion.div>
              ...
              <Card className="border-2 border-slate-200">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">Intel Pentium, AMD Athlon, Celeron, Atom, Core i3 or equivalent legacy setup.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">2GB RAM system memory</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">60MB minimum free drive partition storage space</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-slate-200">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">Windows 10 or 11 running latest build modules</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">Intel Core i3 (3rd Gen or later) / AMD Ryzen series architectures</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">4GB RAM or higher environments</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                      <span className="text-slate-700">100MB disk space to accommodate logs, cache tables, or local analytics outputs</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
      ...
      <FullWidthSection backgroundColor="bg-gradient-to-br from-slate-900 to-emerald-900" className="relative overflow-hidden py-24">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center max-w-3xl mx-auto"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Explore Your Schemas?</h2>
            <p className="text-xl text-emerald-100 mb-8 leading-relaxed">
              Instantly run SchemaLence today to interactively analyze databases, check constraints, and inspect your structural relationships.
            </p>

            <Button
                onClick={handleDownload}
                disabled={isDownloading}
                className="bg-emerald-600 hover:bg-emerald-700 text-white w-full py-6 text-lg font-semibold max-w-md mx-auto flex items-center justify-center shadow-lg"
                >
                {isDownloading ? "Processing File..." : "💾 Download SchemaLence App"}
            </Button>
