              ...
              <div className="flex gap-4 text-sm">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`flex items-center justify-center w-10 h-10 bg-slate-800 rounded-full text-slate-400 transition-colors duration-300 ${social.color}`}
                  >
                    <motion.span className="sr-only">{social.name}</motion.span>
                    <social.icon className="w-5 h-5" />
                  </motion.a>
                ))}
              </div>
        ...
        >
          <div className="max-w-6xl mx-auto text-sm">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex flex-wrap gap-6 text-sm text-slate-400 justify-center md:justify-end">
                {/* FIX: Discrete Admin Login link placed right here inside metadata links row */}
               
                <Link href="/login" passHref>
                  <span className="hover:text-emerald-400 transition-colors font-medium cursor-pointer">Admin</span>
                </Link>
